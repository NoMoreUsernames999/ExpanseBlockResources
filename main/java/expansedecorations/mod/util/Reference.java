package expansedecorations.mod.util;

public class Reference 
{
	public static final String MODID = "expansedecorations";
	public static final String MODNAME = "Expanse decoration resources";
	public static final String VERSION = "1.12.2";
	
	public static final String CLIENT = "expansedecorations.mod.proxy.ClientProxy";
	public static final String SERVER = "expansedecorations.mod.proxy.CommonProxy";
